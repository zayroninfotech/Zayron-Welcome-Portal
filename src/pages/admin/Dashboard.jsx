        ...
        <div style={{
          ...
          <div style={{ position:'relative', zIndex:1 }}>
            ...
            <div style={{ display:'flex', gap:10 }}>
              <Link to="/admin/employees/new" style={{ background:'#fff', color:'#0d1b4b', borderRadius:10, padding:'9px 18px', fontSize:13, fontWeight:700, textDecoration:'none', display:'inline-flex', alignItems:'center', gap:6 }}>
                + Add Employee
              </Link>
              <Link to="/admin/employees" style={{ background:'rgba(255,255,255,0.12)', color:'#fff', borderRadius:10, padding:'9px 18px', fontSize:13, fontWeight:600, textDecoration:'none', border:'1px solid rgba(255,255,255,0.2)' }}>
                View Team →
              </Link>
            </div>
          </div>
          ...
          <div style={{ display:'flex', gap:24, position:'relative', zIndex:1 }}>
            {[
              { val: total, lbl: 'Total Staff', color:'#60a5fa' },
              { val: stats?.joining_this_month || 0, lbl: 'Joined This Month', color:'#34d399' },
              { val: `${completionRate}%`, lbl: 'Onboarded', color:'#fbbf24' },
            ].map(s => (
              <div key={s.lbl} style={{ textAlign:'center' }}>
                <div style={{ fontSize:32, fontWeight:900, color:s.color, lineHeight:1 }}>{s.val}</div>
                <div style={{ fontSize:11, color:'rgba(255,255,255,0.5)', marginTop:4, fontWeight:500 }}>{s.lbl}</div>
              </div>
            ))}
          </div>
        </div>
