...
SECRET_KEY = os.getenv('SECRET_KEY', 'zayron-infotech-secret-key')
...
# Static files — Django serves React build from static/dist/
STATIC_URL = '/static/'
...
# CORS — only needed during development if you run Vite separately
